...
ALLOWED_HOSTS = [
    ...
    for host in config(
        "ALLOWED_HOSTS",
        default=".onrender.com,karaokedocowboy.art.br,www.karaokedocowboy.art.br,localhost,127.0.0.1",
    ).split(",")
    if host.strip()
]
...
CSRF_TRUSTED_ORIGINS = [
    ...
    for origin in config(
        "CSRF_TRUSTED_ORIGINS",
        default="https://karaokedocowboy.art.br,https://www.karaokedocowboy.art.br",
    ).split(",")
    if origin.strip()
]
